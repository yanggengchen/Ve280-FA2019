...
{
    // TODO:
	If(market1=2_status == 0) {
		throw market2_status;
	}
	else {
...
int main(int argc, char* argv[])
{
    ...
    try 
    {
        ...
        catch( /* TODO: */ bool err1)
        {
            cout << "market2 is closed!" << endl;
            flag = 0;
        }
        catch( /* TODO: */ int need_apples)
        {
            cout << "Apples in market2 are not enough. You still need " << /* TODO: */ need_apples << " more." << endl;
            flag = 0;
        }  
    }
    catch( /* TODO: */ bool err2 )
    {
        cout << "market1 is closed!" << endl;
        flag = 0;
    }
    catch( /* TODO: */ float need_flour)
    {
        cout << "Flour in market1 is not enough. You still need " << /* TODO: */ need_flour<< " grams more." << endl;
        flag = 0;
    }
    catch( /* TODO: */ int need_eggs)
    {
        cout << "Eggs in market1 are not enough. You still need " << /* TODO: */need_eggs << " more." << endl;
        flag = 0;
    }
